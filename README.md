...
- **kp_to_op** - Folder przechowujący jsony z danymi o technologii z kart przedmiotów w ofertach pracy.
- **technology_statistics_2025** - Folder przechowujący skrypty generujące roczne i miesięczne statystyki technologii.
...
- **kp_to_op_algorithm_with_tokenization.py** - wykonuje porównanie pokrycia technologii z ofert pracy na karty przedmiotów. Wykorzystuje dane o ofertach pracy z folderu **job_offers_tokenized**. Wyniki zapisuje w pliku **kp_to_op_matches.json** w folderze głównym projektu. Nazwę pliku wynikowego należy następnie zmienić ręcznie na odpowiednią plikowi z ofert pracy. Plik ofert pracy wybieramy ręcznie poprzez zmianę nazwy w kodzie.
- **kp_to_op_algorithm_without_tokenization.py** - Wykonuje porównanie pokrycia fraz z kart przedmiotów na oferty pracy. Wykorzystuje dane o ofertach pracy z folderu **job_offers_json**. Wyniki zapisuje w pliku **kp_to_op_matches_no_tokenization.json** w folderze **kp_to_op**. Plik ofert pracy wybieramy ręcznie poprzez zmianę nazwy w kodzie.Nazwę pliku wynikowego należy zmienić ręcznie na odpowiednią plikowi z ofert pracy.
...
- **technology_statistics_2025.py** - agreguje statystyki użycia technologii z rocznej serii plików **kp_to_op** i **op_to_kp** i zapisuje wyniki do **technology_statistics_2025.json**.
- **technology_statistics_month.py** - agreguje statystyki użycia technologii z miesięcznej serii plików **kp_to_op** i **op_to_kp** i zapisuje wyniki do **technology_statistics_month.json**.
...
7. Odpalić **kp_to_op_algorithm_without_tokenization.py** osobno dla każdego pliku z ofertami pracy.
8. Uruchomić skrypt statystyczny **technology_statistics_2025** bądź **technology_statistics_month**.
